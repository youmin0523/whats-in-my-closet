...
const STEPS = [
  { n: "01", t: "사진으로 올리기", d: "한 장씩, 또는 여러 장 한 번에. 나머지는 AI가 알아서 읽어요." },
  { n: "02", t: "AI가 자동 분류", d: "카테고리·색상·계절까지 자동으로 태깅. 정리는 AI한테 맡겨요." },
  { n: "03", t: "사기 전 중복 경고", d: "비슷한 옷이 이미 있으면 0–100 점수로 알려줘요." },
  { n: "04", t: "위치·코디까지", d: "어디 뒀는지 찾아주고, 오늘 날씨에 맞는 코디도 추천해요." },
];
...
const FEATURES = [
  {
    tag: "중복 감지",
    t: "비슷한 옷, 또 사기 전에",
    d: "이미 가진 옷과 색·디자인이 얼마나 닮았는지 AI가 점수로 알려줘요. 매장에서, 사기 전에.",
  },
  {
    tag: "위치 추적",
    t: "어디 뒀는지 바로",
    d: "‘네이비 니트는 안방 옷장 둘째 서랍’. 어디 뒀는지 기억해 두고 2D·3D로 찾아줘요.",
  },
  {
    tag: "실시간 인벤토리",
    t: "지금 내 옷장, 한눈에",
    d: "상의 24 · 하의 18 · 양말 12켤레. 카테고리·색상별 수량을 실시간으로 들여다봐요.",
  },
];
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-16 md:grid-cols-2 md:px-10 md:py-24">
            <div className="duration-700 animate-in fade-in slide-in-from-bottom-3">
              ...
              <p className="mt-6 max-w-md text-pretty text-lg leading-relaxed text-muted-foreground">
                옷을 사진으로 올리면 AI가 카테고리·색상·계절을 자동으로 정리해요.
                비슷한 옷이 있으면 <b className="font-medium text-foreground">사기
                전에 알려주고</b>, 어디 뒀는지 찾아주고, 오늘 뭘 입을지까지.
              </p>
          ...
          <div className="mx-auto max-w-6xl px-6 py-16 md:px-10 md:py-20">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 leading-relaxed text-muted-foreground">
                배경을 지운 옷을 갤러리처럼 진열하고, 카테고리·색상·계절로 골라봐요.
                쇼핑몰에서 옷 고르듯, 이미 가진 옷을 한눈에 보고 입어요.
              </p>
            </div>
